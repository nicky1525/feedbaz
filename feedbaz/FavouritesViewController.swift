...
class FavouritesViewController: UIViewController {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (isBlogs == true) {
             let blog = favouritesArray[indexPath.row] as NSDictionary
            ...
            let blogPost = favouritesArray[indexPath.row] as NSDictionary
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showFavouritesDetails" {
            let controller: HomeController = segue.destinationViewController as! HomeController
    ...
    func clearAllPressed() {
        let alert = UIAlertController(title:nil, message: "Are you sure you want to clear all your favourites?", preferredStyle: UIAlertControllerStyle.Alert)
